...
import { DocumentParser, SupportedFileType } from '../types';

class ParserRegistry {
  private parsers: Map<SupportedFileType, DocumentParser> = new Map();
   ...
   */
  getParserForFile(file: File): DocumentParser | null {
   ...
   */
  getParserForType(fileType: SupportedFileType): DocumentParser | null {
   ...
   */
  hasParserForFile(file: File): boolean {
